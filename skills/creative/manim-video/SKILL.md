...
3. **Default dark background with neon accents** — the cliché "AI art" look
4. **No dominant color** — equal visual weight everywhere means nothing stands out
5. **Flat black backgrounds** — always add subtle texture, gradient, or tint
...
8. **Generic "educational animation" look** — white background, primary colors, basic shapes

### What Makes a Piece Feel "Chosen, Not Generated"

A viewer should feel that a human with taste made deliberate choices:
- Colors feel like they belong to a specific world (midnight blue for math, warm amber for physics)
...
- The overall piece could be described in one evocative phrase: "the clarity of a textbook diagram brought to life" not "a math animation"
